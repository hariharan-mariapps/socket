...
class _MyAppState extends State<MyApp> {
  ...
  TextEditingController _textController = TextEditingController();
   MethodChannel _channel = MethodChannel('usb_communication');

  Future<void> communicateWithUSB() async {
    try {
      await _channel.invokeMethod('communicateWithUSB');
    } catch (e) {
      print('Error communicating with USB: $e');
    }
  }
